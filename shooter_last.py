...
lose_boss = font1.render('LOL kek ! Ты пропустил магическую каку!', True, (180, 0, 0))
...
start_diff = font2.render('1 - Легко, 2 - Норм, 3 - Щмек', True, (255, 0, 255))  # выбор сложности
...
display.set_caption("Супермега шутер!")
    ...
    for e in event.get():
        ...
        # событие нажатия на пробел - спрайт стреляет
            ...
            # событие нажатия на пробел - спрайт стреляет
                ...
                if num_fire < 10000000000000000000000000000000000000000000 and rel_time == False:
                    num_fire = num_fire + 1
                    fire_sound.play()
                    ship.fire()
                if num_fire >= 10000000000000000000000000000000000000000000 and rel_time == False:  # если игрок сделал 5 выстрелов
                    reload_sound.play()
            ...
            # легкий уровень сложности
                ...
                goal = 50
                reload_time = 1
                max_lost = 10000000000000000000000000000000000000000000000000
                life = max_life = 5000000000000000000000000000000000000000000000000000  
                max_enemies = 50000000000000000000000000000000000000000000000000 
